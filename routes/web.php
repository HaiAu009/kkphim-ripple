...
use KKPhim\Ripple\Controllers\RippleController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/rate', config('kkphim.routes.movie', 'phim')), [RippleController::class, 'rateMovie'])
        ->name('movie.rating');
